        ...
        <div class="content table-responsive">
          ...
          @foreach ($datas as $data)
            ...
            <tr class="record">
              ...
              <td class="col-1">
                <a href="{{ route('orders-by-customer.index', [ 'data' => $data['customer']->last_name ] ) }}"
                  class="record-link"
                  title="Select all orders of the customer">{{ $data['customer']->last_name }}
                </a>
              </td>
              <td class="col-1">{{ $data['category']->category_name }}</td>
              ...
              <td class="col-1">{{ $data['orderstatus']->order_status_name }}</td>
