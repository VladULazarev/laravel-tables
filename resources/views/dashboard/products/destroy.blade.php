<x-app-layout>
  <x-slot name="header">
      <h2 class="font-semibold text-xl text-gray-800 leading-tight">Delete the product</h2>
  </x-slot>
      ...
      <div class="row content mb-5">
        <div class="col-lg-6">
          <section class="form-block relative break-words p-3 mt-3">
            ...
            <h5 class="mb-3">Are you sure to delete the product?</h5>

            <form method="POST" action="{{ route('delete-products', [ 'data' => $data->product_url_name ] ) }}">
              @csrf
              @method("DELETE")
